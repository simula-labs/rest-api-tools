export const API_HOST = ((): string => {
  ...
  switch (environment) {
    case environment?.includes("local") && environment:
      return "http://localhost:3000/admin/v1";
    case environment?.includes("prd") && environment:
      return "https://api.prob-works.com/admin/v1";
    case environment?.includes("stg") && environment:
      return "https://api-stg.prob-works.com/admin/v1";
    case environment?.includes("dev") && environment:
      return "https://api-dev.prob-works.com/admin/v1";
    default:
