...
export type PatchCompaniesCompanyIdRecruitmentsIdUrlParams = {
  companyId: string
  id: string
} | undefined

export type PatchCompaniesCompanyIdRecruitmentsIdResponse = Types.RecruitmentRes
...
export type PatchCompaniesCompanyIdRecruitmentsIdRequestBody = {
  recruitment: {
    ...
    publishmentStatus?: 'draft' | 'published' | 'suspending' | 'terminated' | undefined
...
export const patchCompaniesCompanyIdRecruitmentsId = new BaseRequest<
  PatchCompaniesCompanyIdRecruitmentsIdRequestBody,
  PatchCompaniesCompanyIdRecruitmentsIdResponse,
  PatchCompaniesCompanyIdRecruitmentsIdUrlParams,
  undefined
>({
  requiredAuth: true,
  method: "patch",
