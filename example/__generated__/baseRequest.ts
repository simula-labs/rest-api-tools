import axios, { AxiosInstance, AxiosRequestHeaders, AxiosResponse, AxiosResponseTransformer } from "axios";
    ...
    const pParams = ((): Record<string, unknown> | FormData | undefined => {
      ...
      switch (this.contentType) {
        ...
        default:
          return (
            params &&
            (humps.decamelizeKeys(params as unknown as Record<string, unknown>) as Record<string, unknown>)
          );
      }
    })();
